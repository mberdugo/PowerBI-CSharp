...
namespace Microsoft.PowerBI.Api
{
    ...
    public static partial class EmbedTokenOperationsExtensions
    {
            ...
            /// or Dataset.Read.All&lt;/li&gt;&lt;/ul&gt;Note that when `allowEdit` is set
            /// to `false`, the client can still go into edit mode, but they can’t save any
            /// changes.&lt;br/&gt;To set the permissions scope, see [Register an
